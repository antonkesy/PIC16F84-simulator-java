...
public class SimulatorGUI {
  ...
  public SimulatorGUI() {
    ...
    // PortAPin Listener
    portAPins =
        new JCheckBox[] {pAp0CheckBox, pAp1CheckBox, pAp2CheckBox, pAp3CheckBox, pAp4CheckBox};
  ...
  private void resetPIC() {
    if (pic != null) {
      if (isAutoRun) switchAutoRunSimulator();
      setPIC();
    }
  }
