...
public class PIC16F84 {
  ...
  private void instructionHandler() {
    ...
    switch (currentInstruction.getType()) {
      case ADDWF:
        result =
            ArithmeticLogicUnit.add(
                ram, wRegister, ram.getDataFromAddress(currentInstruction.getFK()));
      ...
      case COMF:
        result =
            ArithmeticLogicUnit.getCompliment(ram.getDataFromAddress(currentInstruction.getFK()));
      ...
      case MOVF:
        ...
        setResultInDestination(
            currentInstruction.getBD(), currentInstruction.getFK(), valueOfAddress);
        break;
      case MOVWF:
      ...
      case SUBWF:
        result =
            ArithmeticLogicUnit.sub(
                ram, ram.getDataFromAddress(currentInstruction.getFK()), wRegister);
        setResultInDestination(currentInstruction.getBD(), currentInstruction.getFK(), result);
        break;
      case SWAPF:
      ...
      case BCF:
        ram.setDataToAddress(
            ...
            getBitClearF(
                currentInstruction.getBD(), ram.getDataFromAddress(currentInstruction.getFK())));
        break;
      case BSF:
        ram.setDataToAddress(
            currentInstruction.getFK(),
