...
/** Utility KLasse Wandelt den Opcode in Instruktions und Werte um */
public final class InstructionDecoder {
  ...
  public static Instruction byteOrientedInstruction(int opcode) {
    ...
    switch (instructionCode) {
      case 0b111:
        // ADDWF
        resultInstruction =
            new Instruction(InstructionType.ADDWF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b101:
        // ANDWF
        resultInstruction =
            new Instruction(InstructionType.ANDWF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b1:
        // CLRF & CLRW
        resultInstruction =
            new Instruction(
                is7thBitOne(opcode) ? InstructionType.CLRF : InstructionType.CLRW,
                getByteFs(opcode),
                get7thBit(opcode));
        break;
      case 0b1001:
        // COMF
        resultInstruction =
            new Instruction(InstructionType.COMF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b11:
        // DECF
        resultInstruction =
            new Instruction(InstructionType.DECF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b1011:
        // DECFSZ
        resultInstruction =
            new Instruction(InstructionType.DECFSZ, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b1010:
        // INCF
        resultInstruction =
            new Instruction(InstructionType.INCF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b1111:
        // INCFSZ
        resultInstruction =
            new Instruction(InstructionType.INCFSZ, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b0100:
        // IORWF
        resultInstruction =
            new Instruction(InstructionType.IORWF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b1000:
        // MOVF
        resultInstruction =
            new Instruction(InstructionType.MOVF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b0000:
        // MOVWF & NOP
        ...
        if (opcodeLSBs == 0) {
          ...
          // MOVWF
          resultInstruction =
              new Instruction(InstructionType.MOVWF, getByteFs(opcode), get7thBit(opcode));
        }
        break;
      case 0b1101:
        // RLF
        resultInstruction =
            new Instruction(InstructionType.RLF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b1100:
        // RRF
        resultInstruction =
            new Instruction(InstructionType.RRF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b0010:
        // SUBWF
        resultInstruction =
            new Instruction(InstructionType.SUBWF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b1110:
        // SWAPF
        resultInstruction =
            new Instruction(InstructionType.SWAPF, getByteFs(opcode), get7thBit(opcode));
        break;
      case 0b0110:
        // XORWF
        resultInstruction =
            new Instruction(InstructionType.XORWF, getByteFs(opcode), get7thBit(opcode));
        break;
    }
  ...
  /**
   * Gibt Bit an Position N zurueck LSb == 0
   *
   * @param code
   * @param n
   * @return
  ...
  /**
   * Gibt die Bits in der Range von start bis inclusive end zurueck von rechts nach links Erste ist
   * 0
   *
   * @param code
   * @param startIndex
  ...
  /**
   * Helper ByteOriented Instruktions Fs
   *
   * @param code
   * @return
   */
