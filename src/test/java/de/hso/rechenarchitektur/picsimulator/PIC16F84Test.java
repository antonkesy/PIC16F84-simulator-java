...
public class PIC16F84Test {
   ...
   * @param bD
   */
  public void assertEqualsInstructionLine(
      int posInLine, int posInMemory, InstructionType instructionType, int fK, int bD) {
    Assert.assertEquals(
        new InstructionLine(posInLine, posInMemory, new Instruction(instructionType, fK, bD)),
        testPIC.getCurrentInstructionInRegister());
    testPIC.cycle();
  }
